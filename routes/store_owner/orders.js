function travers(req, res) {
	...
	sql.qry(
		'SELECT id,cost,delivery_cost,info,location,user_id,status,TIMESTAMPDIFF(MINUTE,time_ordered,NOW()) AS elapsed_time,note FROM orders WHERE store_id=? ORDER BY id DESC',
		[store_id],
		function(orders_res) {
			var orders = [];
			async.forEachOf(
